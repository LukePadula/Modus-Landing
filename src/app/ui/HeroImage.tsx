...
export default function HeroImage() {
  return (
    <div
      ...
      className=" max-w-md h-8/12 aspect-[11/16] p-2 grid content-center absolute right-28 bottom-0 border-b-0 rounded-tr-3xl rounded-tl-3xl shadow-2xl border-6 border-black/80"
    >
      ...
      <div className="bg-black/10 h-68 rounded p-5 mb-1">
